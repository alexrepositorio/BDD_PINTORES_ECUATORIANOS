...
<div id="datos">
<input type="hidden" name="var" class="var"  value="<?php echo $codipintor ?>" >
<input type="text" size="20" name="usuario" class="nombre" placeholder="Nick" required="required" autocomplete="off" />
<input type="email" size="20" name="email" class="email" placeholder="Correo eléctronico" required="required" autocomplete="off"/>
