...
<body>
	...
	<section>
					<?php	
						...
						$sql_listar="select * from obra, pintor where  pintor.nombre like '%".($_POST["selector"])."%' and pintor.COD_PINTOR=obra.COD_PINTOR ORDER BY `VOTO` desc";
						$res_sql=mysql_query($sql_listar,$link);
						$num_rows = mysql_num_rows($res_sql);
						echo $num_rows;
